...
class GCN_QA(object):
    ...
    def __init__(self, dropout=1.0):
        ...
        with tf.variable_scope(NAMESPACE):
            ...
            self.Walpha = tf.Variable(tf.random_uniform([2 * self._memory_dim + self._question_vector_size,
                                                         1], -_rw, _rw))
            self.balpha = tf.Variable(tf.random_uniform([1], -_rw, _rw))
            ...
            self.alphas = tf.nn.softmax(self.alphas, dim=0)
